...
print("python counties.py -n -s Oregon -c Douglas")
os.system("python counties.py -n -s Oregon -c Douglas")


print("python counties.py -n -s Oregon -c Curry")
os.system("python counties.py -n -s Oregon -c Curry")
print("python counties.py -n -s Oregon -c Josephine")
os.system("python counties.py -n -s Oregon -c Josephine")
print("python counties.py -n -s Texas -c Harris")
os.system("python counties.py -n -s Texas -c Harris")
print("python counties.py -n -s California -c 'Los Angeles'")
...
print("python lastday.py -n -s 'New Jersey'")
os.system("python lastday.py -n -s 'New Jersey'")
print("python lastday.py -n -s California")
